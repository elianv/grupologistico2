<legend><h3><center>Ordenes de Servicio por N° Contenedor</center></h3></legend> 
            ...
            <?php 
                ...
                echo '</div>';
            ?>
<form class="form-horizontal" id="formulario" action=" <?php echo base_url('index.php/consultas/facturadas/por_contenedor'); ?> " method="post" >
	<fieldset>
		<div class="row">
...
<?php if($tipo == 1){ ?>
	<hr />
	<center><h2><?php echo "Ordenes que contentan como Contenedor : ".$titulo; ?></h2></center>
	<div class="container">
                    <table id="tabla-ordenes-contenedor" class="table table-hover table-condensed table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>N°</th>
                                ...
                                <tbody>
                                    <?php foreach ($ordenes as $orden) { ?>
                                        <tr>
                                            ...
                                            <?php $fecha = new DateTime($orden['fecha_presentacion']); ?>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$('#tabla-ordenes-contenedor').DataTable();	
    });
